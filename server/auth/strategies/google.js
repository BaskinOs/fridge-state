...
const strategy = app => {
  ...
  /*
  ** /api/auth/google: route for client
  ** user click login => hit this url and redirected to Google's servers
  ** we request profile and email address
  */
  app.get(
  ...
  /* /api/auth/google/callback: client redirected here after auth complete
  ** if successful, cookie added 
  */
  app.get(
